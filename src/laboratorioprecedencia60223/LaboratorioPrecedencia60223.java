 ...
 */
package laboratorioprecedencia60223;
 ...
 * @author Jairo
 */
public class LaboratorioPrecedencia60223 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("¿Cúal es el valor de x: ");
        leer.nextLine();
        System.out.println("El valor de x es: " + x);
        boolean b = ( 6 * 6 > (5 + 10) + 20 );
        System.out.println("b = (6 * 6 > (5 + 10) + 20");
        System.out.print("¿cúal es el valor de b: ");
        leer.nextLine();
        ...
        leer.nextLine();
        System.out.println("El arreglo quedo así: { " + arreglo[0] + "," + arreglo[1] + "}");
